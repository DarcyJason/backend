...
use backend::{
    config::Config, constants_and_statics::logo::LOGO, custom::result::AppResult,
    database::client::DBClient, log::logger, routers::api_routers, security::cors::cors,
    shutdown::shutdown_signal, state::AppState,
};
use dotenvy::dotenv;
